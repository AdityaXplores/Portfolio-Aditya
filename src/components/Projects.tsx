...
const portfolioProjects = [
  {
    ...
    title: "Krushi Mitra",
    results: [
      { title: "Built a scalable scheme portal using React and TypeScript." },
      { title: "Integrated Appwrite auth for 10K+ users." },
      { title: "Enhanced scheme search with UX filters (↑60% discoverability)." },
    ],
  ...
  {
    company: "Tech",
    year: "HTML, CSS, React, Tailwind CSS, Next.js, Firebase, Appwrite, Vercel",
    title: "Farm Manager",
    results: [
      { title: "Built responsive dashboard for farmer data access." },
      { title: "Used reusable components and Tailwind UI system." },
      { title: "Optimized state management for performance." },
      { title: "Collaborated using agile for scalable UI delivery." },
    ],
    link: "",
    image: FarmManager,
  },
