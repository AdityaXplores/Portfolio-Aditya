  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <div className="h-2 w-2 rounded-full bg-emerald-300 transition-all duration-1000 group-hover:scale-[100.8]"></div>
        <span className="inline-block transition-all duration-75 group-hover:translate-x-12 group-hover:opacity-0">
          {children}
        </span>
      </div>
